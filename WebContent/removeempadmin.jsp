...
<%@page import="com.startup.controller.admin.*"%>
...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
  ...
  System.out.println("sales .hrid. create page...."+adminid);
	  if(adminid==null)
	  {
	   %>
						...
						<table  class="table-condensed " align="center" border="1px solid" style="background: wheat;">
						  <thead>	
							...
							<tr>	
							    ...
							    <td><a  href="REA?id=<%=rs.getString(1)%>"><button type="button" class="glyphicon glyphicon-trash btn btn-danger">Delete Profile</button></a></td>
