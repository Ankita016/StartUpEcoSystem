  ...
  <body class="hold-transition skin-blue sidebar-mini">
            ...
            <ul class="nav navbar-nav">
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><%=session.getAttribute("empid") %></span>
                </a>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <ul class="timeline">
                ...
                <!-- END timeline item -->
                <!-- timeline item -->
      <%!String status; int bal; ResultSet rs=null; %>
      <%
		   	ResultSet rs=null;
	...
	<% 
		...
		try
		{
			...
			{
			PreparedStatement ps=con.prepareStatement("select * from leaves where id=?");
			ps.setString(1, id);
			 rs=ps.executeQuery();
