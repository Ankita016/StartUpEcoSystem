	...
	<% 
		...
		try
		{
			String role = request.getParameter("role");
			 System.out.println("!!!jsp!---role...."+request.getParameter("role"));
			AdminModel am = new AdminModel();
			Connection con=am.getDbConnection();
			PreparedStatement ps=con.prepareStatement("select * from adminemp where department_name=? ");
			ps.setString(1, role);
			rs=ps.executeQuery();
			if(rs.next())
	 		{
						...
						<table  class="table-condensed " align="center" border="1px solid" style="background: wheat;">
						  <thead>	
							...
							<tr>	
							    ...
							    <td><a  href="removeemployee?id=<%=rs.getString(1)%>"><button type="button" class="glyphicon glyphicon-trash btn btn-danger">Delete Profile</button></a></td>
