<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
  ...
  <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p><%=(String)session.getAttribute("salesid") %></p>
        ...
        <%
         String sid = (String)session.getAttribute("salesid");
        System.out.println("aside salles..."+sid);
         session.setAttribute("folioid",sid);
         %> 
            <li class="treeview">
              <a href="#">
                <i class="glyphicon glyphicon-user"></i>
                ...
                <li><a href="portfolio.jsp"> </a>
	            			...
	            			<li class="treeview">
				              ...
				              <ul class="treeview-menu">
				                ...
				                <li><a href="removeproject.jsp"><i class="fa fa-circle-o"></i> Remove Project</a></li>
				                <li><a href="showproject.jsp"><i class="fa fa-circle-o"></i>Show Project</a></li>
				              </ul>
				            </li>
				            <li>
				              <a href="#">
				              ...
				              <ul class="treeview-menu">
				                <li><a href="addclient.jsp"><i class="fa fa-circle-o"></i> Add New Client</a></li>
				                <li><a href="removeclient.jsp?id=<%=sid%>"><i class="fa fa-circle-o"></i> Remove Client</a></li>
				                <li><a href="showclient.jsp?"><i class="fa fa-circle-o"></i>Show Client Detail</a></li>
				              </ul>
				            </li>
