...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    <title>Admin | Remove Client</title>
						...
						<table  class="table-condensed " align="center" border="1px solid" style="background: wheat;">
						  <thead>	
							...
							<tr>	
								...
								<td><a  href="RCA?cid=<%=rs.getString(1)%>"><button type="button" class="glyphicon glyphicon-trash btn btn-danger">Delete Client</button></a></td>
