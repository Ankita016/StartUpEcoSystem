...
<script>
   function validateForm() {
    ...
    <title>Finance |Add Income</title>
 ...
 <%
   ...
   <div id="boxForm">
	  <h2 id="title">Add Income</h2>
                <form name="mohit" action="addincome" onsubmit="return validateForm();">
				<table align="center" border=1>
					<tr>
						<td>Source Of Income</td>
						<td><input class='text' placeholder="Enter Source Of Income" type="text" autocomplete="off" name="exp" required></td>
					</tr>
					<tr>
						<td>Amount</td>
