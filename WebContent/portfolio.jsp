...
function validateForm() {
  ...
  <%
    String folioid =(String)session.getAttribute("folioid");
    System.out.println("..id folio.jsp...."+folioid);
  	if(folioid==null)
       {
  %>
            ...
            <div class="col-md-12">
              ...
              <ul class="timeline">
                ...
                <li>
 			    <!-- END timeline item -->
 				<div id="wrapper">
					  <form name="myForm" action="completeportfolio" method="post" onsubmit="return validateForm();" enctype="multipart/form-data">
