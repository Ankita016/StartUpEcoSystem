    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>Finance</b>LT</span>
            ...
            <ul class="nav navbar-nav">
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><%=(String)session.getAttribute("finid") %></span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      <%=(String)session.getAttribute("finid") %>
      ...
      <!-- Content Wrapper. Contains page content -->
       <div class="content-wrapper" style="background-image:url('bootstrap/images/hrhome.jpg'); background-size:contain;">
