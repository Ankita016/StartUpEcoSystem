...
<script>
 ...
 <%
   ...
   <div id="boxForm">
	  <h2 id="title">Add Expenses</h2>
                <form name="mohit" action="addexpense" onsubmit="return validateForm();">
				<table align="center" border=1>
					<tr>
						<td>Expense Area</td>
						<td><input class='text' placeholder="Expense Area" type="text" autocomplete="off" name="exp" required></td>
					</tr>
					<tr>
						<td>Amount</td>
					...
					<tr>
						<td>Expense Type</td>
						<td><input class='text' placeholder="Expense Type" type="text" autocomplete="off"  name="type" required></td>
					</tr>
					<tr>
						<td>Date</td>
