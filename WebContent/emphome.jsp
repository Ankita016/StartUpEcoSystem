...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><%=(String)session.getAttribute("empid") %></span>
                </a>
      ...
      <div class="content-wrapper" style="background-image:url('bootstrap/images/employee.jpg'); background-size:contain; background-size:100%;background-repeat:no-repeat;">
